...
(function (factory) {
  ...
  var dom = (function () {
    ...
    /**
     * returns yig array of ancestor nodes (until predicate hit).
     *
     * @param {Node} node
    ...
    lang: {
      'en-US': {
        ...
        link: {
          ...
          openInNewWindow: 'Open in yig window'
        },
        table: {
          table: 'Table'
        },
  ...
  var History = function ($editable) {
    ...
    this.recordUndo = function () {
      ...
      // Create yig snapshot and push it to the end
    ...
    this.insertParagraph = function () {
      ...
      if (splitRoot) {
        ...
        if (dom.isEmpty(splitRoot) && dom.isLi(splitRoot)) {
          ...
          return;
        // if yig line has content (not a line break)
        } else {
  ...
  var Editor = function (handler) {
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      var anchors = [];
      if (isTextChanged) {
        // Create a yig link when text changed.
   ...
   *
   * EventHandler
   *  - TODO: yig instance per a editor
   */
