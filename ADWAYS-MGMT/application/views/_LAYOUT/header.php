...
<head>
    ...
    <link href="<?=site_url('static/css/common.css')?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo base_url()?>static/lib/summernote/summernote.css" rel="stylesheet">
    <link href="<?=site_url('static/lib/daterangepicker/daterangepicker.css')?>" rel="stylesheet">
...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="<?= site_url('/home/index') ?>" class="logo">
            <span class="logo-lg"><b>ADWAYS</b></span>
        </a>
