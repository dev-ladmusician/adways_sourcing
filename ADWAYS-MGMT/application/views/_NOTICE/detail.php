                ...
                <div class="box box-danger">
                    <div class="form-horizontal">
                        <form id="aw-form"
                              ...
                              action="<?= site_url('notice/submit_update')?>">
                            ...
                            <input type="hidden" name="notice-id" value="<?php echo $item->_noticeid; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-11 sg-item-content">
                                    <textarea id="summary" name="notice-desc" class="form-control"><?php echo $item->summary ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="col-xs-12">
                        ...
                        if ($item->isdeprecated) {
                            ...
                            <a class="btn btn-success pull-right" style="margin-right: 5px;"
                               href="<?= site_url('notice/change_isdeprecated?itemId='.$item->_noticeid).'&isdeprecated=false' ?>">
                                살리기
                            </a>
                            <?php
                        } else {
                            ?>
                            <a class="btn btn-success pull-right" style="margin-right: 5px;"
                               href="<?= site_url('notice/change_isdeprecated?itemId='.$item->_noticeid).'&isdeprecated=true' ?>">
                                삭제하기
                            </a>
                            <?php
                        }
